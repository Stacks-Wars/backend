...
(define-constant PLATFORM-WALLET 'ST1S3D9BTK41ST9GRT225BQFFSYT6VMX7G7MNZ5FB)
(define-constant PLATFORM-FEE u2)
(define-constant TRUSTED-PUBLIC-KEY 0x02d271c7987db45274f35962b7ac60dc790670288d8c8abc370921d9b68b1d46eb)
...
(define-private (transfer-in (amount uint) (sender principal))
  (contract-call? 'ST1S3D9BTK41ST9GRT225BQFFSYT6VMX7G7MNZ5FB.usdcx-dev
    transfer amount sender current-contract none)
)

(define-private (transfer-out (amount uint) (recipient principal))
  (as-contract? ((with-ft 'ST1S3D9BTK41ST9GRT225BQFFSYT6VMX7G7MNZ5FB.usdcx-dev "usdcx-token" amount))
    (try! (contract-call? 'ST1S3D9BTK41ST9GRT225BQFFSYT6VMX7G7MNZ5FB.usdcx-dev
